...
def setup_external_forces(
    ...
    if external_force_method == "translational_force":
        ...
        external_force_set.add_translational_force("force2","Test", Test_force, point_of_application_in_local="m0")
        ...
        external_force_set.add_torque("torque0", "Seg1", Seg1_force)
        external_force_set.add_torque("torque1", "Test", Test_force)

    elif external_force_method == "in_segment_torque":
        external_force_set.add_torque_in_segment_frame("torque0", "Seg1", Seg1_force)
        external_force_set.add_torque_in_segment_frame("torque1", "Test", Test_force)

    elif external_force_method == "in_segment":
        external_force_set.add_in_segment_frame("torque0", "Seg1", np.concatenate((Seg1_force, Seg1_force), axis=0))
        external_force_set.add_in_segment_frame("torque1", "Test", np.concatenate((Test_force, Test_force), axis=0))
