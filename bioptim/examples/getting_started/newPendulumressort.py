...
def main():
    ...
    with open(os.path.join(RESULTS_DIR, "female1_tete.pkl"), "rb") as file:
    ...
    print("prepare ocp")
    filename = "/models/female1_inverse.bioMod"
    print("model : ", filename)
    # ocp = prepare_ocp(biorbd_model_path=filename, final_time=(1,3), n_shooting=n_shooting,min_time=0.02, max_time=4, weight=0.001, n_threads=1)
    ocp = prepare_ocp(biorbd_model_path=CURRENT_DIR + filename, final_time=(1,3), n_shooting=n_shooting,min_time=0.02, max_time=4, weight=0.001, n_threads=1, u_init=u_init, x_init=x_init)
    print("ocp ready")
    ...
    if save == True :
        ...
        with open(os.path.join(RESULTS_DIR, "female1_pelvis.pkl"), "wb") as file:
