...
class Pelvis(BioModSegment):
    ...
    def __init__(
        ...
        meshfile: str = "Model_mesh/pelvis.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class Head(BioModSegment):
    ...
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/tete.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class LeftUpperArm(BioModSegment):
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/bras.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class LeftForearm(BioModSegment):
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/avantbras.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class LeftHand(BioModSegment):
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/main.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class LeftThigh(BioModSegment):
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/thigh.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class LeftShank(BioModSegment):
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/leg_left.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class LeftFoot(BioModSegment):
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/foot.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class RightShank(BioModSegment):
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/leg_right.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class UpperLegs(BioModSegment):
    ...
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/cuisse.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class LowerLegs(BioModSegment):
    ...
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/jambe.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
...
class Feet(BioModSegment):
    ...
    def __init__(
        ...
        rangesQ: list[Vec2] = None,
        mesh: list[Vec3] = [(0, 0, 0)],
        meshfile: str = "Model_mesh/pied.stl",
        meshcolor: Vec3 = None,
        meshscale: Vec3 = None,
        meshrt: Vec3 = None,
        meshxyz: Vec3 = None,
    ...
    def get_origin(human: yeadon.Human) -> Vec3:
        ...
        dir_J = human.J2.end_pos - human.J2.pos
...
class UpperArms(BioModSegment):
    ...
    def __init__(
        ...
        xyz_global = UpperArms.get_origin(human)
        xyz = xyz_global - Shoulder.get_origin(human)
        translations = ""

        mass, com, inertia = combine_rel_inertia(human, ["a0", "b0", "a1", "b1"], xyz_global)
        m_x, m_y, m_z = np.array(RightUpperArm.adapted_meshscale(human)) + np.array(LeftUpperArm.adapted_meshscale(human))
    ...
    @staticmethod
    def get_origin(human: yeadon.Human) -> Vec3:
        """Get the origin of the Upper arms in the global frame centered at Chest' COM."""
        return np.asarray(human.C.pos).reshape(3)

class LowerArms(BioModSegment):
    ...
    def __init__(
        ...
        label = label or LowerArms.__name__
        xyz_global = LowerArms.get_origin(human)
        xyz = xyz_global - UpperArms.get_origin(human)
        translations = ""

        mass, com, inertia = combine_rel_inertia(human, ["a2", "a3", "b2", "b3"], xyz_global)

        m_x, m_y, m_z = np.array(RightForearm.adapted_meshscale(human)) + np.array(LeftForearm.adapted_meshscale(human))
        meshscale = [m_x / 2, m_y / 2, m_z / 2]
        markers = parse_markers(label, markers)
    ...
    @staticmethod
    def get_origin(human: yeadon.Human) -> Vec3:
        """Get the origin of the LowerArmsAndHands in the global frame centered at Chest' COM."""
        return np.asarray((human.A2.pos + human.B2.pos) / 2.0).reshape(3)
...
class Hands(BioModSegment):
    ...
    def __init__(
        ...
        xyz_global = Hands.get_origin(human)
        xyz = xyz_global - LowerArms.get_origin(human)
        translations = ""

        mass, com, inertia = combine_rel_inertia(human, ["a4","a5", "a6", "b4", "b5", "b6"], xyz_global)

        m_x, m_y, m_z = np.array(RightHand.adapted_meshscale(human)) + np.array(LeftHand.adapted_meshscale(human))
        meshscale = [m_x / 2, m_y / 2, m_z / 2]
        parse_markers(label, markers)
    ...
    @staticmethod
    def get_origin(human: yeadon.Human) -> Vec3:
        """Get the origin of the Hands in the global frame centered at Chest' COM."""
        length = (
...
class BioModHumanFusedArms:
    def __init__(self, human: yeadon.Human, gravity: Vec3 = None, **segments_options):
        ...
        self.forearms = LowerArms(
            human,
            parent=self.upperarms.label,
            **segments_options[LowerArms.__name__] if LowerArms.__name__ in segments_options else {},
        )
        self.hands = Hands(
            human,
...
if __name__ == "__main__":
    ...
    if DEBUG_FLAG:
        ...
        class Arguments:
            def __init__(self):
                self.meas = "C:/Users/emmam/Documents/INSA Rennes/MA/Stage math et sports acrobatiques/test_bioptim/merge arm/female1.txt"
    ...
    BioHuman = BioModHumanFusedArms  # Force la fusion
    human_options = {}  # Options supplémentaires si besoin
    segments_options = {}  # Options des segments
